                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-sliders"></i> Configuration <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        ...
                        <!-- <li><a>Services<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu"><a href="activity.php">Activity</a>
                            </li>
                            <li><a href="servicecategory.php">Category</a>
                            </li>
                          </ul>
                        </li> -->
                  ...
                  <li><a><i class="fa fa-shopping-cart"></i> Purchase Management <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                        ...
                        <li><a href="itemreturn.php">Return</a>
                        </li>
                    </ul>
                  </li>
          ...
          <div class="nav_menu">
            <nav>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                  <a data-toggle="tooltip" data-placement="bottom" title="Logout" href="../controllers/logout.php">
                    <span class="glyphicon glyphicon-off" aria-hidden="true"></span>
                  </a>
                </li>
