...
<script type="text/javascript">
  ...
  function loadPriceData() {
    $.ajax({  
      url: '../server.php?c=PriceController&m=getAllCitem',
      type: "POST",  
      dataType: "json",  
      success: function (data) {  
        ...
        for (i = 0; i < data.length; i++) {
          ...
          ' <tr>\
              ...
              <td> '+desc+'  </td>\
              <td>\
                <a href="#" class="btn btn-success btn-xs" onclick="'+func_collect+'"><i class="fa fa-shopping-cart"></i> Collect </a>\
              </td>\
              <td>\
  ...
  function Collect(){
    window.location.replace("recievepayment.php");
  }
  ...
  function updatePrice(){ 
    ...
    var Data={item:item,pvalue:pvalue,hvalue:hvalue,desc:desc,id:id};
