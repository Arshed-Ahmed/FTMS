      ...
      <div class="x_content">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="col-md-3 col-sm-3 col-xs-3">
            <?php
            include("db_conn.php");
            $sql = "SELECT * FROM `company` ORDER BY comId DESC";
            $res = mysqli_query($conn, $sql);
            if (mysqli_num_rows($res) > 0) {
              while ($logo = mysqli_fetch_assoc($res)) { ?>
                <img src="logo/<?= $logo['comLogo'] ?>" alt="Company Logo">
              <?php }
            } else { ?>
              <p style=" color: red;">Please insert the company Logo</p>
            <?php } ?>

            <form action="logo_upload.php" method="POST" enctype="multipart/form-data">
              <div class="item form-group">
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" id="my_logo" name="my_logo" class="form-control col-md-7 col-xs-12" required="required">
                ...
                <input class="btn btn-primary" type="submit" id="logosubmit" name="btnsubmit" value="Change Logo">
              </div>
            </form>
          </div>
          <div class="col-md-9 col-sm-9 col-xs-9">
            <img style="width: 100%;" src="images/Cover.png">
          </div>
                        ...
                        <form id="companyform" class="form-horizontal form-label-left" novalidate>
                          ...
                          <div class="modal-footer">
                            <div class="col-md-6 col-md-offset-3">
                              ...
                              <button id="update" style="display: none;" class="btn btn-success" onclick="updateCompany();">Update</ </div>
                            </div><br>
                            <div class="ln_solid"></div>
                        </form>
                      </div>
